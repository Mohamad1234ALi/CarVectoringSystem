    ...
    st.session_state.messages = [
        {
            "role": "system",
            "content": (
                "You are a knowledgeable and friendly sports assistant. "
                "You help users with sports statistics, match schedules, player info, and general sports news. "
                "Always be concise, informative, and easy to understand."
            )
        }
    ]
